...
const SearchBar = () => {
    ...
    return (
        <div className="sticky top-0 bg-white py-2 z-20">
            <div className="group flex bg-[#EFF3F4] text-[#536471] h-[44px] items-center space-x-3 rounded-full px-5 border border-transparent focus-within:border-[#F4AF01] focus-within:bg-white transition-all">
