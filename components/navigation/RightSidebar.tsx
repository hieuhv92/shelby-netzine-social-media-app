...
export default function RightSidebar() {
    ...
    return (
        <div className="hidden lg:flex flex-col w-[400px] pl-10 sticky top-0 max-h-screen overflow-y-auto no-scrollbar pb-10">
            {/* 1. Search input */}
            {!isSearchOrExplore && (
                <div className="sticky top-0 z-30 bg-white px-3 py-2 border-b border-gray-50">
                    <SearchBox />
                </div>
            )}
